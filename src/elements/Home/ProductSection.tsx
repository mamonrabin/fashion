                        ...
                        <div className="card-container col-6 col-xl-3 col-lg-3 col-md-4 col-sm-6 Tops wow fadeInUp" data-wow-delay="0.6s" key={ind}>
                            <div className="shop-card">
                                ...
                                <div className="dz-content">
                                    <h5 className="title"><Link href="/product-thumbnail">{item.name}</Link></h5>
                                ...
                                <div className="dz-content">
                                    <div className="dz-content-footer">
                                        <div className="dz-content-start">
                                            ...
                                            <h4 className="title mb-1"><Link href="/product-thumbnail">Cozy Knit Cardigan Sweater</Link></h4>
