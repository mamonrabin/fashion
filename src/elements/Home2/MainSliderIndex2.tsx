    ...
    return(
        <div className="main-slider style-2"> 
			<div className="main-swiper2">
							...
							<div className="col-xl-7 col-lg-7 col-md-12 align-self-center">
								<div className="swiper-content">
									...
									<div className="content-btn" data-swiper-parallax="-60">
										...
										<Link className="btn btn-outline-secondary" href="/shop-filters-top-bar">VIEW DETAILS</Link>
									</div>
								</div>
                            </div>
				...
				<Link href="/contact-us-1" className="service-btn btn-dark">Let’s talk</Link>
			</div>
		</div>	
    )
}