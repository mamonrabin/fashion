                    ...
                    <div className={`dz-card blog-half style-6 ${elem.coloumStyle}`}>
                        ...
                        <div className="dz-info">
                            ...
                            <h4 className="dz-title">
                                <Link href="/post-standard">{elem.name}</Link>
                            </h4>
                            <Link href="/post-standard" className="btn btn-theme text-uppercase">Read more<i className="fa-solid fa-arrow-right"/></Link>
                        </div>
                    </div>
                </div> 
            ))}
