...
export default function Header2Menus(){    
    ...
    return(
        <ul className="nav navbar-nav">
            ...
            >
                <Link href="/shop-filters-top-bar"><span>Shop</span><i className="fas fa-chevron-down tabindex" /></Link>                      
            ...
            >
                <Link href="/blog-dark-3-column"><span>Blog</span><i className="fas fa-chevron-down tabindex"/></Link>
                {/* <div className="mega-menu">
                    <ul>                       
            ...
            >
                <Link href="/about-me"><span>About Us</span><i className="fas fa-chevron-down tabindex"/></Link>
                {/* <div className="mega-menu">
                    <ul>
