                        ...
                        <div className="col-xl-3 col-md-4 col-sm-6"  >
                            <div className="widget widget_about me-2">
                                ...
                                <ul className="widget-address">
                                    <li>
                                        <p><span>Address</span> : 451 Wall Street, Mirpur, Dhaka</p>
                                    </li>
                                    <li>
                                        <p><span>E-mail</span> : example@info.com</p>
                                    </li>
                                    <li>
                                        <p><span>Phone</span> : +8801746770324</p>
                                    </li>
                                </ul>
                                    ...
                                    {WidgetData.map((item, ind)=>(
                                        <li key={ind}>
                                            ...
                                            <div className="dz-content">
                                                <h6 className="name"><Link href="/product-thumbnail">{item.name}</Link></h6>
                ...
                <div className="container">
                    <div className="row fb-inner">
                        <div className="col-lg-6 col-md-12 text-start"> 
                            <p className="copyright-text">© <span className="current-year">2025</span> <a href="https://titaswebs.vercel.app/">titasweb</a> All Rights Reserved.</p>
                        </div>
